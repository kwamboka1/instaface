		...
		<>
			<div className='Header bg-purple-200 w-full text-purple-900'>
				<div className='max-w-[1440px] mx-auto py-6 px-10 flex justify-between'>
					...
					<div className='hidden lg:flex'>
						<nav className='flex items-center'>
							<NavLink
								...
								className={({ isActive }) =>
									isActive
										? 'text-purple-900 block p-3 text-lg navlink'
					...
					<div
						onClick={handleNav}
						className='block lg:hidden mr-0 p-2 rounded-2xl hover:bg-purple-900 duration-300'
					>
						{nav ? (
					...
					<div
						className={
							nav
								? 'w-full left-0 flex justify-center text-center bg-purple-200 top-[80px] absolute z-10'
								: 'absolute left-[-100%]'
						}
					>
						<nav className='pb-8'>
