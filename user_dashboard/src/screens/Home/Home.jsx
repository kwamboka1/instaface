			...
			<>
				...
				<div className='grid place-content-center'>
					<p className='text-xl text-purple-900'>
						{' '}
						Dear{' '}
						<span className='start text-blue-900 underline text-sm'>
							{user?.email} ,
						</span>{' '}
					</p>
					<small className='text-transparent bg-clip-text bg-gradient-to-r from-purple-900 to-orange-500'>
						<em>
							You are viewing this page because you are logged in or you just
							signed up, Have fun!
						</em>
					</small>
					&#128540;
					<h1 className='text-6xl text-transparent bg-clip-text bg-gradient-to-r from-purple-900 to-orange-500 inline-block font-bold'>
						DashBoard
					</h1>
					<hr />
					<tbody className='border border-slate-500  border-spacing-4  my-12'>
						<tr>
							<th className='text-2xl text-purple-900 border border-none border-separate border-spacing-2'>
								Users
							</th>
							<th className='border border-none text-2xl text-purple-900 pl-48'>
								Number of Albums
							</th>
						</tr>
						<hr />
